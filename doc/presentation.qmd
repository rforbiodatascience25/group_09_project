...
![**Workflow for identification of T cells responses using DNA barcode p-MHC-I multimer technology**](images/Barcoding (2).png){fig-align="center"}

## Introduction

![Focus on mapping complete SARS-CoV-2 genome](images/SARS-CoV-2 Structure .png){fig-align="center"}
...
Although ORF1 produced the most peptides, the most immunogenic protein, relative to its size, is ORF3. ::: ::: \## Immunogenic Epitopes Distribution {.smaller}
